...
import rightArrow from '../../images/right-arrow.png'; // Путь к изображению правой стрелки
import leftArrow from '../../images/left-arrow.png'; // Путь к изображению левой стрелки
...
const testimonials = [
    ...
    },
    {
        ...
        name: " Константин,",
        profession: "руководитель отдела web-разработки, компания \«Авто-Альянс\»",
        product: "Английский язык",
    },
    {
        id: 5,
    ...
    },
    {
        ...
        name: "Матвей",
        profession: "студент Байкальского государственного университета, будущий IT специалист",
        product: "Английский язык"
    },
    {
        id: 8,
                    ...
                    {currentTestimonials.map((testimonial, index) => {
                        ...
                        return (
                            <div className={`testimonial-card ${isUpperRow ? 'upper' : 'lower'} ${isExpanded ? 'expanded' : ''}`} key={testimonial.id}>
                                <p className="quote">
                                    {isExpanded || testimonial.text.length <= 600 ? testimonial.text : `${testimonial.text.slice(0, 600)}...`}
                                </p>
                                {!isExpanded && testimonial.text.length > 600 && (
