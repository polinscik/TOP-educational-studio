...
const testimonials = [
  ...
  {
    id: 2,
    text: "Супер учитель 🔥 у детей появился интерес к английскому языку, это заслуга Дианы. Большая благодарность за ее труд и уникальный подход !!! Дети ждут каждый урок с нетерпением!",
    name: "Ольга,",
