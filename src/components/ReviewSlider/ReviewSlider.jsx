...
const reviews = [
    ...
    {
        text: "Супер! Все ожидания оправданы.",
        name: "Наталья",
...
const ReviewSlider = () => {
    ...
    return (
        <div className="review-slider">
            <h2 className='review-heading'>Отзывы о нас</h2>
            <Slider {...settings}>
                {reviews.map((review, index) => (
                    <div key={index} className="review-card">
                        <p className="review-text">{review.text.length > 150 ? `${review.text.substring(0, 150)}... Читать больше` : review.text}</p>
