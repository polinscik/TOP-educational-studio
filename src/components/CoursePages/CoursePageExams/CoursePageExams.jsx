...
function ExamsRowMainDesc() {
  return (
    <Fragment>
      Курс «Exams» – кладезь знаний для ребят-героев, принявших решение сдавать
      английский на ОГЭ и ЕГЭ! Экзамен непростой, и готовиться к нему нужно
      максимально осознанно и серьёзно.
...
function GraduateRowMainDesc() {
  return (
    <Fragment>
      ...
      вооружённым до зубов мощными знаниями по русскому языку! Есть пробелы? Не
      переживай! Мы поможем! С нами ты вспомнишь всё, что забыл, и узнаешь всё,
      чего не знал!
      <p style={{marginTop: "2vh"}}>На курсе мы:</p>
      <ul>
